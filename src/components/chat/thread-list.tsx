      ...
      <QueryView
        ...
        loading={
          <div className="space-y-2" role="status" aria-label="Loading conversations">
            {[0, 1, 2].map((i) => (
              <div key={i} className="flex gap-3 rounded-card border border-hairline bg-surface p-3">
                ...
                <li key={thread.id}>
                  <Link
                    ...
                    className={cn(
                      ...
                      active ? "border-leash bg-sky" : "border-hairline bg-surface hover:border-ink-faint",
                    )}
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-0.5 flex items-center justify-between gap-2">
                        ...
                        {thread.unread > 0 ? (
                          <span className="inline-flex min-w-5 shrink-0 items-center justify-center rounded-full bg-leash px-1.5 text-label leading-5 font-bold text-surface">
                            {thread.unread}
